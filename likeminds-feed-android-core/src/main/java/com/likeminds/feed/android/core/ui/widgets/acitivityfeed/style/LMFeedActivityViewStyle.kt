 ...
 * @property timestampTextStyle: [LMFeedPostingViewStyle] this will help you to customize the timestamp text in the activity view | set its value to [null] if you want to hide the timestamp in the activity view
